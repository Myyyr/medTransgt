...
from nnformer.network_architecture.nnformer_gt import swintransformer
...
class nnFormerGT5TrainerV2_Synapse(nnFormerTrainer_synapse):
    """
    ...
    def initialize_network(self):
        ...
        self.network = swintransformer(self.num_input_channels, self.base_num_features, self.num_classes,
                                    ...
                                    dropout_op_kwargs,
                                    net_nonlin, net_nonlin_kwargs, True, False, lambda x: x, InitWeights_He(1e-2),
                                    self.net_num_pool_op_kernel_sizes, self.net_conv_kernel_sizes, False, True, True,gt_num=5)
    ...
    def do_split(self):
        ...
        for i in tr_keys:
            ...
            self.dataset_tr[i] = self.dataset[j]
